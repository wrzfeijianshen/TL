...
public:
    ...
    void setupUi(QMainWindow *samp1_2Class)
    {
        if (samp1_2Class->objectName().isEmpty())
            samp1_2Class->setObjectName(QStringLiteral("samp1_2Class"));
    ...
    {
        samp1_2Class->setWindowTitle(QApplication::translate("samp1_2Class", "samp1_2", Q_NULLPTR));
        label->setText(QApplication::translate("samp1_2Class", "\344\275\240\345\245\275\357\274\214Visual Studio 2015", Q_NULLPTR));
    } // retranslateUi
