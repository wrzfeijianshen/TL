...
namespace DuiLib
{
	...
	void CLabelUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		if (_tcscmp(pstrName, _T("align")) == 0) {
			...
			bool bEnable = _tcscmp(pstrValue, _T("true")) == 0;
			SetEndEllipsis(bEnable);
		}
	...
	void CLabelUI::SetAlign(LPCTSTR pstrValue)
	{
	...
	void CLabelUI::SetEndEllipsis(bool _EnabledEndEllipsis)
	{
		if (_EnabledEndEllipsis)
		{
