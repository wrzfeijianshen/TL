...
void CWindowWnd::ShowWindow(bool bShow /*= true*/, bool bTakeFocus /*= false*/)
{
	...
	::SetWindowPos(m_hWnd, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE);				// modify by Aries 2016/10/08
	::SetWindowPos(m_hWnd, HWND_NOTOPMOST, 0, 0, 0, 0, SWP_NOSIZE | SWP_NOMOVE);			// modify by Aries 2016/10/08

	::ShowWindow(m_hWnd, bShow ? (bTakeFocus ? SW_SHOW : SW_SHOWNOACTIVATE) : SW_HIDE);		// modify by Aries 2016/10/08

	//RECT rcWnd = { 0 };
	//::GetWindowRect(m_hWnd, &rcWnd);
	//rcWnd.right = rcWnd.right - rcWnd.left;
	//rcWnd.bottom = rcWnd.bottom - rcWnd.top;
	//::SetWindowPos(m_hWnd, HWND_TOPMOST, rcWnd.left, rcWnd.top, rcWnd.right, rcWnd.bottom, SWP_SHOWWINDOW);		// modify by Aries 2016/10/08
	//::SetWindowPos(m_hWnd, HWND_NOTOPMOST, rcWnd.left, rcWnd.top, rcWnd.right, rcWnd.bottom, SWP_SHOWWINDOW);	// modify by Aries 2016/10/08
